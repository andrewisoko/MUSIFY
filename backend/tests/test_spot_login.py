...
def test_client_id():
    ...
    app_fastapi.add_api_route("/spot-login", oauth.spotify_login, methods=["GET"])
    client_for_clientid = TestClient(app_fastapi)
    ...
    # with no client Id in the parameter = Missing required parameter; client_id
